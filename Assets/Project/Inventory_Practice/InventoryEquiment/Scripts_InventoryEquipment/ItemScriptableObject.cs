...
public class ItemScriptableObject : ScriptableObject
{
    ...
    public GameObject pfItem; //todo gameobject chua chua sprite render + meshRender => Set itemWorld3D khi spawn ra scene
    ...
    public GameObject pfWeaponInterface; //todo gameobject chua class handInterface.cs : IWeapon
