...
public class UI_Item_Alls : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IPointerClickHandler 
{
    ...
    public void OnBeginDrag(PointerEventData eventData) {
        ...
        UI_ItemDrag_Alls.Instance.Show(item);
    }
    ...
    void SetNameText(string name) => nameText.text = name.ToString();
    void SetPowerText(int power) => powerText.text = "Power: " + power.ToString();
    public void Hide() {
